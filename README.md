...
1. **Data Collection**  
2. **Transformation in Power Query**  
3. **Normalization of HPSA → Medical Need Index (MNI)**  
4. **Building the Drone Need Index (DNI)**  
5. **Power BI & Python visualizations**  
6. **Route simulation using Google Earth Studio**
